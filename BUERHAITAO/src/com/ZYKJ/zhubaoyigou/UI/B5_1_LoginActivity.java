...
//				startActivity(intent_B0_MainActivity);
			...
			case R.id.login_tv:
				/*QQ登录*/
				UMQQSsoHandler qqSsoHandler = new UMQQSsoHandler(this, "1104838121",
		                "pVW8Eu68H2cnB3PO");
			...
			case R.id.login_tv2:
				/*微信登录*/
				UMWXHandler wxHandler = new UMWXHandler(this,"wx9e0a35a17c3d797e","226ea0847a03510f9ab9f8c1ceed6762");
